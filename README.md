...
~~~sh
# getting the code
git clone git@github.com:nko4/rockem-sockem.git && cd ./rockem-sockem/

# developing
npm install
npm start

# deploying (to http://rockem-sockem.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@rockem-sockem.2013.nodeknockout.com
ssh root@rockem-sockem.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@rockem-sockem.2013.nodeknockout.com
ssh -i ./id_deploy root@rockem-sockem.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/rockem-sockem" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
